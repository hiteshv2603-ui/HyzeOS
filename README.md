...
Once HyzeOS boots, you'll see the HyzeOS prompt. Type `help` to see available commands:
...
HyzeOS includes a Python script to convert videos into ASCII art format:
